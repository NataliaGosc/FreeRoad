...
public class WeatherActivity extends AppCompatActivity {
    ...
    final String APP_ID = "1538b84d374aca4c09191cac0f8d4f15";
    final String WEATHER_UTL = "http://api.openweathermap.org/data/2.5/weather";
    ...
    LocationListener mLocationLisner;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mCityFinder.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(WeatherActivity.this, CityChangeActivity.class);
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if(requestCode==REQUEST_CODE)
        {
            ...
            {
               Toast.makeText(WeatherActivity.this,"Location get Succesffully",Toast.LENGTH_LONG).show();
               getWeatherForCurrentLocation();
            }
            else
            {
                //uzytkownik odmowil uprawnienia
            }
        }
    }
    ...
    private void updateUI(WeatherDataActivity weather) {
    ...
    protected void onPause() {
        ...
        {
            mLocationManager.removeUpdates(mLocationLisner);
        }
    }
}